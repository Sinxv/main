export const data = {
    translations: {
        ...
        general: {
            back: {
                en: "← Game Progression",
                es: "← Progresión del Juego",
                kr: "← 게임 진행",
                jp: "← ゲーム進行",
                br: "← Progressão do Jogo"
            },
            footer: {
                en: "If you have any information that you can contribute, please contact",
                es: "Si tienes información que puedas contribuir, por favor contacta a",
                kr: "기여할 정보가 있으면 다음으로 연락해 주세요",
                jp: "情報提供がありましたら、下記までご連絡ください",
                br: "Se você tiver alguma informação para contribuir, por favor entre em contato com"
            },
            footer_discord: {
                en: "on discord",
                es: "en discord",
        ...
        stage3: {
            ...
            sections: {
                ...
                artifact_system: {
                    ...
                    artifact_leveling: {
                        ...
                        content: {
                            en: [
                                "Artifact has 4 stages, each with 9 levels; whenever artifact surpasses level 9, it will go up a stage and reset to level 1, up to Stage 4 Level 1", "After reaching Stage 3 unlock Hidden Power", "After reaching Stage 4 unlock an Extra Passive Force Skill Slot."
                            ],
                            es: [
                                ""
                            ],
                    ...
                    artifact_equipment: {
                        ...
                        contentp1: {
                            en: [
                                "Consists of 5 parts, Circlet, Armor, Necklace, and 2 Rings; each part has different and really powerful stats, Additional Effects are different from the ones that items often have, so they're quite special, and important for Combat Power increase, equipment also has 1 effect line per piece under the name of 'Spirit Stones' including a set effect for 2/4/5 spirit stones assembled, down below will lay all the possible stats for each thing."
                            ],
                            es: [
                                ""
                            ],
                    ...
                    hiddenpower: {
                        ...
                        content: {
                            en: [
                                "Hidden Power is a set of 3 lines with different stats, serving as an 'Extra' reward for leveling up your Artifact, you are given a free chance to roll stats, after identifying them for the first time you'll need an artifact something scroll (will change later) to change your stats","All possible stats for each line are listed down below:"
                            ],
                            es: [
                                ""
                            ],
                    ...
                    spiritstones: {
                        content: {
                            en: [
                                "Artifact Spirit Stone Wedges can be used once per Artifact equipment piece, this will unlock a slot to Assemble 1 Spirit Stone, with 100 Spirit Stone Fragments, obtainable via Pruinaum Outskirts Daily Reward. you can also select 5 Spirit stones of a specific value via Dr. Pho's Guide.","When spending 100 Fragments to roll a random value, a random stat will appear, with certain color, each possible value has 5 colors: Yellow, Green, Blue, Orange and Red.","Each Spirit Stone needs to be of the same color to account for the Set Effect."
                            ],
                            es: [
                                ""
                            ],
                    ...
                    artifact_seteffect: {
                        content: {
                            en: [
                                "After your Artifact reaches Stage 4, and you assemble 2, 4 or 5 Spirit Stones of the same color, Artifact Set Effect will be activated.","Each Spirit Stone color has a different Set Effect, which give different useful traits;"
                            ],
                            es: [
                                ""
                            ],
                        ...
                        conclusion: {
                            en: [
                                "Usage of Yellow Set Effect is recommended for DPS, and Green for Supports, others don't grant as much benefits as those two, so theyre either not popular or unused."
                            ],
                            es: [
                                ""
                            ],
            ...
            notices: {
                raid_party: {
                    en: "Raid Parties can't get Party Assemble buff, meaning queue is pointless, just press \"Start Now\" button *",
                    es: "Los grupos de incursión no pueden obtener el beneficio de Reunión de Grupo, lo que significa que hacer cola no tiene sentido, simplemente presiona el botón \"Comenzar ahora\" *",
                    kr: "레이드 파티는 파티 모집 버프를 받을 수 없으므로 대기열은 의미가 없습니다. \"지금 시작\" 버튼을 누르세요 *",
                    jp: "レイドパーティーはパーティー募集バフを受け取れないため、待機列は無意味です。\"今すぐ開始\"ボタンを押してください *",
                    br: "Grupos de raide não podem receber o bônus de Reunião de Grupo, o que significa que a fila é inútil, basta pressionar o botão \"Começar Agora\" *"
                },
                boss_freezing: {
                    en: "Bosses are freezable 3 times each 60 seconds (refreshed on phase clear) *",
                    es: "Los jefes se pueden congelar 3 veces cada 60 segundos (se reinicia al limpiar la fase) *",
                    kr: "보스는 60초마다 3번 얼릴 수 있습니다(페이즈 클리어 시 재설정) *",
                    jp: "ボスは60秒ごとに3回凍結可能です(フェーズクリアでリセット) *",
                    br: "Chefes podem ser congelados 3 vezes a cada 60 segundos (reinicia ao limpar a fase) *"
                },
                mystic_access: {
                    en: "To access this system, go to Blacksmith → Mystic Enhancement, Each change costs 200,000 ED but even if you roll, as long as you dont apply it, you can keep your previous values. *",
                    es: "Para acceder a este sistema, ve al Herrero → Mejora Mística, Cada cambio cuesta 200,000 ED pero incluso si tiras, siempre que no lo apliques, puedes mantener tus valores anteriores. *",
                    kr: "이 시스템에 접근하려면 대장장이 → 신비한 강화로 이동하세요. 각 변경에는 200,000 ED가 들지만 롤을 해도 적용하지 않으면 이전 값을 유지할 수 있습니다. *",
                    jp: "このシステムにアクセスするには、鍛冶屋 → 神秘の強化に移動します。各変更には200,000 EDかかりますが、ロールしても適用しなければ以前の値を保持できます。 *",
                    br: "Para acessar este sistema, vá ao Ferreiro → Aprimoramento Místico, Cada alteração custa 200.000 ED, mas mesmo se você rolar, desde que não aplique, pode manter seus valores anteriores. *"
                },
                spiritstoneassembly_access: {
                    en: "To access this system, go to Denif in Elrianode or Vasili / Chief Betty in Magmelia → Spirit Stone Assembly, Each change costs 200,000 ED. similarly to previous systems, even if you roll, as long as you dont apply it, you can keep your previous values. *",
                    es: "",
                    kr: "",
                    jp: "",
                    br: ""
            ...
            table_headers: {
                ...
                arti_seteffect_headers: {
                    ase: {
                        en: "Artifact Set Effect",
                        es: "",
                        kr: "", 
                        jp: "",
                        br: ""
            ...
            stats: {
                ...
                physical_attack_level: {
                    en: "Physical Attack Level",
                    es: "Nivel de Ataque Físico",
                    kr: "물리 공격력 레벨",
                    jp: "物理攻撃力レベル",
                    br: "Nível de Ataque Físico"
                },
                physical_attack: {
                    en: "Physical Attack",
                    es: "Ataque Físico",
                ...
                physical_defense_percent: {
                    en: "Physical Defense %",
                    es: "% de Defensa Física",
                    kr: "물리 방어력 %",
                    jp: "物理防御力%",
                    br: "% da Defesa Física"
                },
                physical_defense_level: {
                    en: "Physical Defense Level",
                    es: "Nivel de Defensa Fisica",
                    kr: "물리 방어력 레벨",
                    jp: "物理防御力レベル",
                    br: "Nível de Defesa Física"
                },
                physical_defense: {
                    en: "Physical Defense",
                    es: "Defensa Física",
                ...
                action_speed: {
                    en: "Action Speed",
                    es: "Velocidad de Acción",
                    kr: "행동 속도",
                    jp: "アクション速度",
                    br: "Velocidade de Ação"
                },
                max_mp: {
                    en: "Max MP Increase",
                    es: "Incremento de MP Máximo",
                    kr: "최대 MP 증가",
                    jp: "最大MP増加",
                    br: "Aumento de MP Máximo"
                },
                all_skill_dmg: {
                    en: "All Skill Damage",
                    es: "Daño de todas las Habilidades",
                    kr: "모든 스킬 데미지",
                    jp: "全スキルダメージ",
                    br: "Dano de Todas as Habilidades"
                },
                double_attack: {
                    en: "Double Attack Chance",
                    es: "Probabilidad de Ataque Doble",
                    kr: "더블 어택 확률",
                    jp: "ダブルアタック確率",
                    br: "Chance de Ataque Duplo"
                },
                elemental_act_chance: {
                    en: "Elemental Activation Chance",
                    es: "Probabilidad de Activación Elemental",
                    kr: "속성 발동 확률",
                    jp: "属性発動確率",
                    br: "Chance de Ativação Elemental"
                },
                dmg_red: {
                    en: "Damage Reduction",
                ...
                idr: {
                    en: "Item Drop Rate",
                    es: "Tasa de Obtención de Objetos",
                    kr: "아이템 드롭률",
                    jp: "アイテムドロップ率",
                    br: "Taxa de Drop de Itens"
                },
                dmg_boss: {
                    en: "Damage Dealt to Boss Monsters",
                    es: "Daño a Monstruos Jefe",
                    kr: "보스 몬스터에게 주는 피해",
                    jp: "ボスモンスターへのダメージ",
                    br: "Dano Causado a Monstros Chefes"
                },
                crit_dmg: {
                    en: "Critical Damage",
                    es: "Daño Crítico",
                ...
                skill_cdr: {
                    ...
                    es: "Reducción de Enfriamiento de Habilidad",
                    kr: "스킬 재사용 대기시간 감소",
                    jp: "スキルクールダウン減少",
                    br: "Redução de Recarga de Habilidade"
                },
                awk_duration: {
                    en: "Awakening Duration",
                    es: "Duración del Despertar",
                    kr: "각성 지속 시간",
                    jp: "覚醒持続時間",
                    br: "Duração do Despertar"
                },
                awk_charge: {
                    en: "Awakening Charge Speed",
                    es: "Velocidad de carga del Despertar",
                    kr: "각성 충전 속도",
                    jp: "覚醒チャージ速度",
                    br: "Velocidade de Carga do Despertar"
                },
                hp_increase: {
                    en: "HP Increase",
                    es: "Incremento de PV",
                ...
                mag_def_lv: {
                    en: "Magical Defense Level",
                    es: "Nivel de Defensa Mágica",
                    kr: "마법 방어력 레벨",
                    jp: "魔法防御力レベル",
                    br: "Nível de Defesa Mágica"
                },
                mag_def_perc: {
                    en: "Magical Defense %",
                    es: "% de Defensa Mágica",
                    kr: "마법 방어력 %",
                    jp: "魔法防御力%",
                    br: "% da Defesa Mágica"
                },
                ...
                mag_atk_lv: {
                    en: "Magical Attack Level",
                    es: "Nivel de Ataque Mágico",
                    kr: "마법 공격력 레벨",
                    jp: "魔法攻撃力レベル",
                    br: "Nível de Ataque Mágico"
                },
                mag_atk_perc: {
                    en: "Magical Attack %",
                    es: "% de Ataque Mágico",
                ...
                artifact_amsd: {
                    en: "All Master Skill Damage Increase",
                    es: "Incremento de Daño de todas las habilidades maestras",
                    kr: "",
                    jp: "",
                    br: ""
                },
                artifact_cmsd: {
                    en: "Stage 1/2/3/4 Master Skill Damage Increase",
                    es: "Incremento de Daño de la habilidad maestra de etapa 1/2/3/4",
                    kr: "",
                    jp: "",
                    br: ""
                },
                artifact_amscdr: {
                    en: "All Master Skill Cooldown Decrease",
                    es: "Reduccion de enfriamiento de todas las habilidades maestras",
                    kr: "",
                    jp: "",
                    br: ""
                },
                artifact_cmscdr: {
                    en: "Stage 1/2/3/4 Master Skill Cooldown Decrease",
                    es: "Reduccion de enfriamiento de la habilidad maestra de etapa 1/2/3/4",
                    kr: "",
                    jp: "",
                    br: ""
                },
                artifact_ams_size: {
                    en: "All Master Skill Size Increase",
                    es: "Incremento de tamaño de todas las habilidades maestras",
                    kr: "",
                    jp: "",
                    br: ""
                },
                artifact_cmsmpr: {
                    en: "Stage 1/2/3/4 Master Skill MP Cost Decrease",
                    es: "",
                    kr: "",
                    jp: "",
                    br: ""
                },
                artifact_ams_mpr: { // likely unexistant
                    en: "All Master Skill Size MP Cost Decrease",
                    es: "",
                    kr: "",
                    jp: "",
                    br: ""
                ...
                artifact_cms_size: {
                    en: "Stage 1/2/3/4 Master Skill Size Increase",
                    es: "Incremento de tamaño de la habilidad maestra de etapa 1/2/3/4",
                    kr: "",
                    jp: "",
                    br: ""
                },
                artifact_phys: {
                    en: "Physical Damage Increase",
                    es: "Incremento de Daño Físico",
                    kr: "",
                    jp: "",
                    br: ""
                },
                artifact_mag: {
                    en: "Magical Damage Increase",
                    es: "Incremento de Daño Magico",
                    kr: "",
                    jp: "",
                    br: ""
                },
                artifact_cdmg: {
                    en: "Critical Damage Increase",
                    es: "Incremento de Daño Critico",
                    kr: "",
                    jp: "",
                    br: ""
                },
                artifact_bdmg: {
                    en: "Damage Dealt to Bosses",
                    es: "",
                    kr: "",
                    jp: "",
                    br: ""
                ...
                artifact_aspd: {
                    en: "Action Speed Increase",
                    es: "Incremento de Velocidad de Acción",
                    kr: "",
                    jp: "",
                    br: ""
                },
                ...
                artifact_ma_exp: {
                    en: "Master Artifact EXP Increase",
                    es: "Incremento de EXP del Artefacto Maestro",
                    kr: "",
                    jp: "",
                    br: ""
                },
                artifact_s1ms: {
                    en: "Stage 1 Master Skill Damage Increase",
                    es: "",
                    kr: "",
                    jp: "",
                    br: ""
                ...
                artifact_s2ms: {
                    en: "Stage 2 Master Skill Damage Increase",
                    es: "",
                    kr: "",
                    jp: "",
                    br: ""
                ...
                artifact_s3ms: {
                    en: "Stage 3 Master Skill Damage Increase",
                    es: "",
                    kr: "",
                    jp: "",
                    br: ""
                ...
                artifact_s4ms: {
                    en: "Stage 4 Master Skill Damage Increase",
                    es: "",
                    kr: "",
                    jp: "",
                    br: ""
                ...
                artifact_hasd: {
                    en: "Hyperactive Skill Damage Increase",
                    es: "",
                    kr: "",
                    jp: "",
                    br: ""
                ...
                artifact_elementres: {
                    en: "All Element Resistance Increase",
                    es: "",
                    kr: "",
                    jp: "",
                    br: ""
                ...
                artifact_amsdefign: {
                    en: "All Master Skill Defense Ignore",
                    es: "",
                    kr: "",
                    jp: "",
                    br: ""
                ...
                artifact_ascdr: {
                    en: "All Skill Cooldown Decrease",
                    es: "",
                    kr: "",
                    jp: "",
                    br: ""
                ...
                artifact_phys_mag_def: {
                    en: "Physical / Magical Defense Increase",
                    es: "",
                    kr: "",
                    jp: "",
                    br: ""
                ...
                artifact_cmd_act_sd: {
                    en: "Command / Active Skill Damage Increase",
                    es: "",
                    kr: "",
                    jp: "",
                    br: ""
                ...
                artifact_tsd: {
                    en: "Tenacity Skill Damage Increase",
                    es: "",
                    kr: "",
                    jp: "",
                    br: ""
                ...
                artifact_ssd: {
                    en: "Strength Skill Damage Increase",
                    es: "",
                    kr: "",
                    jp: "",
                    br: ""
                ...
                artifact_bsd: {
                    en: "Bravery Skill Damage Increase",
                    es: "",
                    kr: "",
                    jp: "",
                    br: ""
                ...
                artifact_ha_ms_sd: {
                    en: "Hyperactive / Master Skill Damage Increase",
                    es: "",
                    kr: "",
                    jp: "",
                    br: ""
                ...
                artifact_asd: {
                    en: "All Skill Damage Increase",
                    es: "",
                    kr: "",
                    jp: "",
                    br: ""
                },
                artifact_phys_mag_atk: {
                    en: "Physical / Magical Attack Power Increase",
                    es: "",
                    kr: "",
                    jp: "",
                    br: ""
                ...
                artifact_igndef: {
                    en: "Ignore Enemy Physical / Magical Defense",
                    es: "",
                    kr: "",
                    jp: "",
                    br: ""
                ...
                artifact_pola: {
                    en: "Polarize: Attack / Attacked Damage Increase",
                    es: "",
                    kr: "",
                    jp: "",
                    br: ""
                },
                artifact_seteffect_2pcvalues: {
                    yellow: {
                        en: [
                            "Upon Awakening, All Skill Cooldown -10% (20s Cooldown)","Upon Awakening, Increase Critical/Maximize by 8%. (Multiplicative)"
                        ],
                        es: [
                            ""
                        ],                       
                    ...
                    green: {
                        en: [
                            "Upon using Special Active Skill, Recover Party's HP/MP +4% per 500K Combat Power (Max 24%, 20s Cooldown)"
                        ],
                        es: [
                            ""
                        ],                       
                    ...
                    blue: {
                        en: [
                            "When total All Resistance exceeds 1000, increase All Skill Damage by 4%."
                        ],
                        es: [
                            ""
                        ],                       
                    ...
                    orange: {
                        en: [
                            "HP Increase by 5% when entering dungeon with a Environment Debuff."
                        ],
                        es: [
                            ""
                        ],                       
                    ...
                    red: {
                        en: [
                            "Damage Reduction -2%","Deals additional continuous damage by 1% of the damage dealt in 3s."
                        ],
                        es: [
                            ""
                        ],                       
                ...
                artifact_seteffect_4pcvalues: {
                    ...
                    blue: {
                        en: [
                            "+50 points of resistance added to all attributes.","Damage Reduction +10%"
                        ],
                        es: [
                            ""
                        ],                       
                    ...
                    red: {
                        en: [
                            "Polarize: Attack/Attacked Damage +3%"
                        ],
                        es: [
                            ""
                        ],                       
                ...
                artifact_seteffect_5pcvalues: {
                    yellow: {
                        en: [
                            "Upon Awakening, Increase Physical/Magical Attack Power by 4%","Upon Awakening, MP Cost -10%"
                        ],
                        es: [
                            ""
                        ],                       
                    ...
                    green: {
                        en: [
                            "Buff - Nearby Party's Physical/Magical Attack Power +0.5% per 500K Combat Power (Max 4%)"
                        ],
                        es: [
                            ""
                        ],                       
                    ...
                    blue: {
                        en: [
                            "Every 8% of Damage Reduction increase Physical/Magical Attack Power by 1% (Max 4%)"
                        ],
                        es: [
                            ""
                        ],                       
                    ...
                    orange: {
                        en: [
                            "Damage to Boss Monsters Increase by 10% / Damage from Boss Monsters Decrease by 10% when entering a dungeon with Environment Debuff."
                        ],
                        es: [
                            ""
                        ],                       
                    ...
                    red: {
                        en: [
                            "Damage Reduction -4%","Deals additional continuous damage by 2% of the damage dealt in 3s."
                        ],
                        es: [
                            ""
                        ],                       
        ...
        tableNotes: {
            NotRecommended: {
                ...
                es: "Esta estadística no se recomienda para un DPS óptimo",
                kr: "이 스탯은 최적의 DPS를 위해 권장되지 않습니다",
                jp: "このステータスは最適なDPSには推奨されません",
                br: "Este status não é recomendado para DPS ideal"
            },
            SurvNiche: {
                en: "This stat is usable over the niche of survivability",
                es: "Esta estadística es utilizable para el nicho de supervivencia",
                kr: "이 스탯은 생존성 틈새 시장에 사용할 수 있습니다",
                jp: "このステータスは生存率のニッチで使用可能です",
                br: "Este status é utilizável para o nicho de sobrevivência"
            },
            InflationNiche: {
                en: "This stat is usable over the niche of CP inflation, not recommended for DPS purposes",
                es: "Esta estadística es utilizable para el nicho de inflación de CP, no recomendada para fines de DPS",
                kr: "이 스탯은 전투력 인플레이션 틈새 시장에 사용할 수 있지만 DPS 목적으로는 권장되지 않습니다",
                jp: "このステータスはCPインフレのニッチで使用可能ですが、DPS目的には推奨されません",
                br: "Este status é utilizável para o nicho de inflação de CP, não recomendado para fins de DPS"
            },
            IDRNiche: {
                en: "Stat used for specific item farming purposes, keep this stat away from the dps weapon, instead build a new one",
                es: "Estadística utilizada para fines específicos de obtención de objetos, mantén esta estadística alejada del arma de dps, en su lugar construye una nueva",
                kr: "특정 아이템 파밍 목적으로 사용되는 스탯, 이 스탯을 DPS 무기에서 멀리하고 대신 새 것을 제작하세요",
                jp: "特定のアイテム収集目的で使用されるステータス、このステータスをDPS武器から遠ざけ、代わりに新しいものを作成してください",
                br: "Status usado para fins específicos de coleta de itens, mantenha este status longe da arma de dps, em vez disso, construa uma nova"
            },
            EXPNiche: {
            ...
            PVPNiche: {
                en: "This stat is usable, due to being useful in PvP",
                es: "Esta estadística es utilizable, debido a que es útil en PvP",
                kr: "이 스탯은 PvP에서 유용하기 때문에 사용할 수 있습니다",
                jp: "このステータスはPvPで有用であるため使用可能です",
                br: "Este status é utilizável, por ser útil no PvP"
            },
            PHNiche: {
                en: "This stat is not recommended for optimal DPS, but can be kept as a good placeholder when you don't have enough resources to perfect your rolls",
                es: "Esta estadística no se recomienda para un DPS óptimo, pero se puede mantener como un buen marcador de posición cuando no tienes suficientes recursos para perfeccionar tus tiradas",
                kr: "이 스탯은 최적의 DPS를 위해 권장되지 않지만, 롤을 완벽하게 만들 자원이 충분하지 않을 때 좋은 임시 자리 표시자로 유지할 수 있습니다",
                jp: "このステータスは最適なDPSには推奨されませんが、ロールを完璧にするのに十分なリソースがない場合、良いプレースホルダーとして保持できます",
    ...
    skills: {
        ...
        "Els_DodgeStep":{
            name: "Dodge Step",
            icon: "images/Elsword/Skills/DodgeStep.png",
            tier: "Active",
            type: "Defensive",
            base: {
            }
        ...
        "Els_FlameGeyser":{
            name: "Flame Geyser",
            icon: "images/Elsword/Skills/FlameGeyser.png",
            tier: "Bravery",
            type: "Offensive",
            base: {
                damage: 1175,
        ...
        "Els_IronBody":{
            name: "Iron Body",
            icon: "images/Elsword/Skills/IronBody.png",
            tier: "Active",
            type: "Buff",
            base: {
                effects: []
        ...
        "Els_MegaSlash":{
            name: "Mega Slash",
            icon: "images/Elsword/Skills/MegaSlash.png",
            tier: "Active",
            type: "Offensive",
            base: {
                damage: 1175,
        ...
        "Els_Roll":{
            name: "Roll",
            icon: "images/Elsword/Skills/Roll.png",
            tier: "Active",
            type: "Defensive",
            base: {
                effects: []
        ...
        "Els_TripleGeyser":{
            name: "Triple Geyser",
            icon: "images/Elsword/Skills/TripleGeyser.png",
            tier: "Bravery",
            type: "Offensive",
            base: {
                damage: 1175,
        ...
        "Els_UnlimitedBlade":{
            name: "Unlimited Blade",
            icon: "images/Elsword/Skills/UnlimitedBlade.png",
            tier: "Bravery",
            type: "Offensive",
            base: {
                damage: 1175,
        ...
        "KE_ArmorBreak":{
            name: "Armor Break",
            icon: "images/Elsword/Skills/KE/ArmorBreak.png",
            tier: "Active",
            type: "Offensive",
            base: {
                damage: 1175,
                effects: ["30% Physical Defense Reduction"]
            },
            mod: {
                damage: 1175,
                effects: ["50% Physical Defense Reduction","Enrages enemies hit and increases their Attack Power for a certain duration"]
            }
        },
        "KE_GiganticSlash":{
            name: "Gigantic Slash",
            icon: "images/Elsword/Skills/KE/GiganticSlash.png",
            tier: "Hyperactive",
            type: "Offensive",
            base: {
                damage: 1175,
        ...
        "KE_AbsoluteJudgement":{
            name: "Absolute Judgement",
            icon: "images/Elsword/Skills/KE/AbsoluteJudgement.png",
            tier: "Hyperactive",
            type: "Offensive",
            base: {
                damage: 1175,
        ...
        "KE_ArmageddonBlade":{
            ...
            icon: "images/Elsword/Skills/KE/ArmageddonBlade.png",
            tier: "Tenacity",
            type: "Offensive",
            base: {
                damage: 1175,
        ...
        "KE_RollingSmash":{
            name: "Rolling Smash",
            icon: "images/Elsword/Skills/KE/RollingSmash.png",
            tier: "Strength",
            type: "Offensive",
            base: {
                damage: 1175,
        ...
        "KE_ShoulderTackle":{
            ...
            icon: "images/Elsword/Skills/KE/ShoulderTackle.png",
            tier: "Tenacity",
            type: "Offensive",
            base: {
                damage: 1175,
        ...
        "KE_Sandstorm":{
            name: "Sandstorm",
            icon: "images/Elsword/Skills/KE/Sandstorm.png",
            tier: "Strength",
            type: "Offensive",
            base: {
                damage: 1175,
        ...
        "KE_Windmill":{
            name: "Windmill",
            icon: "images/Elsword/Skills/KE/Windmill.png",
            tier: "Strength",
            type: "Offensive",
            base: {
                damage: 1175,
        ...
        "KE_CounterAttack":{
            name: "Counter Attack",
            icon: "images/Elsword/Skills/KE/CounterAttack.png",
            tier: "Active",
            type: "Offensive",
            base: {
                damage: 1175,
        ...
        "KE_VerticalSlash":{
            name: "Vertical Slash",
            icon: "images/Elsword/Skills/KE/VerticalSlash.png",
            tier: "Strength",
            type: "Offensive",
            base: {
                damage: 1175,
        ...
        "KE_SonicBlade":{
            name: "SonicBlade",
            icon: "images/Elsword/Skills/KE/SonicBlade.png",
            tier: "Strength",
            type: "Offensive",
            base: {
                damage: 1175,
        ...
        "KE_SonicBladeCrescent":{
            name: "Sonic Blade - Crescent",
            icon: "images/Elsword/Skills/KE/SonicBladeCrescent.png",
            tier: "Strength",
            type: "Offensive",
            base: {
                damage: 1175,
        ...
        "KE_PowerSmash":{
            name: "Power Smash",
            icon: "images/Elsword/Skills/KE/PowerSmash.png",
            tier: "Strength",
            type: "Offensive",
            base: {
                damage: 1175,
        ...
        "KE_ImperialCrusher":{
            ...
            icon: "images/Elsword/Skills/KE/ImperialCrusher.png",
            tier: "Strength",
            dtype: "Offensive",
            base: {
                damage: 1175,
        ...
        "KE_GrandCross":{
            name: "Grand Cross",
            icon: "images/Elsword/Skills/KE/GrandCross.png",
            tier: "Bravery",
            type: "Offensive",
            base: {
                damage: 1175,
        ...
        "KE_Kick":{
            name: "Kick",
            icon: "images/Elsword/Skills/KE/Kick.png",
            tier: "Active",
            type: "Offensive",
            base: {
                damage: 1175,
        ...
        "KE_SpiralBlast":{
            name: "Spiral Blast",
            icon: "images/Elsword/Skills/KE/SpiralBlast.png",
            tier: "Strength",
            type: "Offensive",
            base: {
                damage: 1175,
        ...
        "KE_MortalBlow":{
            name: "Mortal Blow",
            icon: "images/Elsword/Skills/KE/MortalBlow.png",
            tier: "Tenacity",
            type: "Offensive",
            base: {
                damage: 1175,
        ...
        "KE_ImpactSmash":{
            name: "Impact Smash",
            icon: "images/Elsword/Skills/KE/ImpactSmash.png",
            tier: "Strength",
            type: "Offensive",
            base: {
                damage: 1175,
        ...
        "KE_DoubleSlash":{
            name: "Double Slash",
            icon: "images/Elsword/Skills/KE/DoubleSlash.png",
            tier: "Bravery",
            type: "Offensive",
            base: {
                damage: 1175,
        ...
        "KE_SwordOfTheSunSolariusS1":{
            name: "Sword of the Sun - Solarius (Stage 1)",
            icon: "images/Elsword/Skills/KE/SwordOfTheSunSolariusS1.png",
            tier: "Master Skill",
            type: "Offensive",
            base: {
                damage: 1175,
        ...
        "KE_SwordOfTheSunSolariusS4":{
            name: "Sword of the Sun - Solarius (Stage 4)",
            icon: "images/Elsword/Skills/KE/SwordOfTheSunSolariusS4.png",
            tier: "Master Skill",
            type: "Offensive",
            base: {
                damage: 1175,
        ...
        "Ros_Backstep":{
            name: "Backstep",
            icon: "images/Rose/Skills/Backstep.png",
            tier: "Active",
            type: "Deffensive",
            base: {
                effects: []
        ...
        "Ros_Barbecue":{
            name: "Barbecue!",
            icon: "images/Rose/Skills/Barbecue.png",
            tier: "Bravery",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "Ros_M-3Flamethrower":{
            ...
            icon: "images/Rose/Skills/M-3Flamethrower.png",
            tier: "Bravery",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "Ros_M-137GatlingGun":{
            ...
            icon: "images/Rose/Skills/M-137GatlingGun.png",
            tier: "Active",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "Ros_RX-78LandRunner":{
            ...
            icon: "images/Rose/Skills/RX-78LandRunner.png",
            tier: "Tenacity",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "Ros_Spriggan":{
            name: "Spriggan",
            icon: "images/Rose/Skills/Spriggan.png",
            tier: "Active",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        // -------------------------------------------------------------------------------------------- Black Massacre Skills
        "BlM_BloodAndChain":{
            name: "Blood And Chain",
            icon: "images/Rose/Skills/BlM/BloodAndChain.png",
            tier: "Hyperactive",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "BlM_BloodBullet":{
            name: "Blood Bullet",
            icon: "images/Rose/Skills/BlM/BloodBullet.png",
            tier: "Active",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "BlM_BloodyCarnival":{
            name: "Bloody Carnival",
            icon: "images/Rose/Skills/BlM/BloodyCarnival.png",
            tier: "Bravery",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "BlM_BloodyChain":{
            name: "Bloody Chain",
            icon: "images/Rose/Skills/BlM/BloodyChain.png",
            tier: "Active",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "BlM_BloodyRoad":{
            name: "Bloody Road",
            icon: "images/Rose/Skills/BlM/BloodyRoad.png",
            tier: "Strength",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "BlM_BloodySpike":{
            name: "Bloody Spike",
            icon: "images/Rose/Skills/BlM/BloodySpike.png",
            tier: "Tenacity",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "BlM_ChainPowder":{
            name: "Chain Powder",
            icon: "images/Rose/Skills/BlM/ChainPowder.png",
            tier: "Active",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "BlM_ChainSnatch":{
            name: "ChainSnatch",
            icon: "images/Rose/Skills/BlM/ChainSnatch.png",
            tier: "Tenacity",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "BlM_ChainViper":{
            name: "ChainViper",
            icon: "images/Rose/Skills/BlM/ChainViper.png",
            tier: "Hyperactive",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "BlM_DestroyersChain":{
            name: "Destroyer's Chain",
            icon: "images/Rose/Skills/BlM/DestroyersChain.png",
            tier: "Hyperactive",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "BlM_DoubleGunhawk":{
            name: "Double Gunhawk",
            icon: "images/Rose/Skills/BlM/DoubleGunhawk.png",
            tier: "Strength",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "BlM_GunDance":{
            name: "GunDance",
            icon: "images/Rose/Skills/BlM/GunDance.png",
            tier: "Strength",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "BlM_GunGuard":{
            name: "Gun Guard",
            icon: "images/Rose/Skills/BlM/GunGuardd.png",
            tier: "Tenacity",
            type: "Defensive",
            base: {
                effects: []
        ...
        "BlM_HeadShot":{
            name: "Head Shot",
            icon: "images/Rose/Skills/BlM/HeadShot.png",
            tier: "Active",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "BlM_KillPoint":{
            name: "Kill Point",
            icon: "images/Rose/Skills/BlM/KillPoint.png",
            tier: "Tenacity",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "BlM_MovingShot":{
            name: "MovingShot",
            icon: "images/Rose/Skills/BlM/MovingShot.png",
            tier: "Tenacity",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "BlM_MultiHeadShot":{
            name: "MultiHeadShot",
            icon: "images/Rose/Skills/BlM/MultiHeadShot.png",
            tier: "Strength",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "BlM_PlainMadnessS1":{
            name: "Plain Madness (Stage 1)",
            icon: "images/Rose/Skills/BlM/PlainMadnessS1.png",
            tier: "Master Skill",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "BlM_PlainMadnessS4":{
            name: "Plain Madness (Stage 4)",
            icon: "images/Rose/Skills/BlM/PlainMadnessS4.png",
            tier: "Master Skill",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "BlM_Punishment":{
            name: "Punishment",
            icon: "images/Rose/Skills/BlM/Punishment.png",
            tier: "Bravery",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "BlM_RushingDance":{
            name: "Rushing Dance",
            icon: "images/Rose/Skills/BlM/RushingDance.png",
            tier: "Strength",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "BlM_WesternFire":{
            name: "Western Fire",
            icon: "images/Rose/Skills/BlM/WesternFire.png",
            tier: "Active",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        // ---------------------------------------------------------------------------------------- Noah Base Skills
        "Noa_ChillingCrescent":{
            name: "Chilling Crescent",
            icon: "images/Noah/Skills/ChillingCrescent.png",
            tier: "Bravery",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "Noa_DarkMoon":{
            name: "Dark Moon",
            icon: "images/Noah/Skills/DarkMoon.png",
            tier: "Bravery",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "Noa_Fission":{
            name: "Fission",
            icon: "images/Noah/Skills/Fission.png",
            tier: "Active",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "Noa_HiddenBlade":{
            name: "Hidden Blade",
            icon: "images/Noah/Skills/HiddenBlade.png",
            tier: "Active",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "Noa_MoonShadow":{
            name: "Moon Shadow",
            icon: "images/Noah/Skills/MoonShadow.png",
            tier: "Tenacity",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "Noa_QuickStrike":{
            name: "Quick Strike",
            icon: "images/Noah/Skills/QuickStrike.png",
            tier: "Bravery",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "Noa_TheHourBetweenDogAndWolf":{
            name: "The Hour Between Dog And Wolf",
            icon: "images/Noah/Skills/TheHourBetweenDogAndWolf.png",
            tier: "Tenacity",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "Lib_Ambush":{
            name: "Ambush",
            icon: "images/Noah/Skills/Lib/Ambush.png",
            tier: "Active",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "Lib_Boundary":{
            name: "Boundary",
            icon: "images/Noah/Skills/Lib/Boundary.png",
            tier: "Active",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "Lib_ChillingEdge":{
            name: "Chilling Edge",
            icon: "images/Noah/Skills/Lib/ChillingEdge.png",
            tier: "Strength",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "Lib_DanceOfMidnight":{
            ...
            icon: "images/Noah/Skills/Lib/DanceOfMidnight.png",
            tier: "Tenacity",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "Lib_DarkWhisper":{
            name: "Dark Whisper",
            icon: "images/Noah/Skills/Lib/DarkWhisper.png",
            tier: "Active",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "Lib_DevouredMoon":{
            name: "Devoured Moon",
            icon: "images/Noah/Skills/Lib/DevouredMoon.png",
            tier: "Hyperactive",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "Lib_DreamEater":{
            name: "Dream Eater",
            icon: "images/Noah/Skills/Lib/DreamEater.png",
            tier: "Strength",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "Lib_Ensnare":{
            name: "Ensnare",
            icon: "images/Noah/Skills/Lib/Ensnare.png",
            tier: "Tenacity",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "Lib_InstantOpening":{
            ...
            icon: "images/Noah/Skills/Lib/InstantOpening.png",
            tier: "Strength",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "Lib_Mirage":{
            name: "Mirage",
            icon: "images/Noah/Skills/Lib/Mirage.png",
            tier: "Tenacity",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "Lib_MoonEclipseS1":{
            name: "Moon Eclipse (Stage 1)",
            icon: "images/Noah/Skills/Lib/MoonEclipseS1.png",
            tier: "Master Skill",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "Lib_MoonEclipseS4":{
            name: "Moon Eclipse (Stage 4)",
            icon: "images/Noah/Skills/Lib/MoonEclipseS4.png",
            tier: "Master Skill",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "Lib_NeedleIce":{
            name: "Needle Ice",
            icon: "images/Noah/Skills/Lib/NeedleIce.png",
            tier: "Strength",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "Lib_NewMoonsShadow":{
            ...
            icon: "images/Noah/Skills/Lib/NewMoonsShadow.png",
            tier: "Bravery",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "Lib_ObsidianMoon":{
            name: "Obsidian Moon",
            icon: "images/Noah/Skills/Lib/ObsidianMoon.png",
            tier: "Strength",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "Lib_Pursuit":{
            name: "Pursuit",
            icon: "images/Noah/Skills/Lib/Pursuit.png",
            tier: "Strength",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "Lib_Rupture":{
            name: "Rupture",
            icon: "images/Noah/Skills/Lib/Rupture.png",
            tier: "Tenacity",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "Lib_ShadowAmbush":{
            name: "Shadow Ambush",
            icon: "images/Noah/Skills/Lib/ShadowAmbush.png",
            tier: "Strength",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "Lib_ShadowFang":{
            name: "Shadow Fang",
            icon: "images/Noah/Skills/Lib/ShadowFang.png",
            tier: "Strength",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "Lib_SharpWound":{
            name: "Sharp Wound",
            icon: "images/Noah/Skills/Lib/SharpWound.png",
            tier: "Strength",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "Lib_SilentAbyss":{
            name: "Silent Abyss",
            icon: "images/Noah/Skills/Lib/SilentAbyss.png",
            tier: "Strength",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "Lib_SliceAndDice":{
            name: "Slice and Dice",
            icon: "images/Noah/Skills/Lib/SliceAndDice.png",
            tier: "Tenacity",
            type: "Offensive",
            base: {
                damage: 100,
        ...
        "Lib_TheEnd":{
            name: "The End",
            icon: "images/Noah/Skills/Lib/TheEnd.png",
            tier: "Hyperactive",
            type: "Offensive",
            base: {
                damage: 100, // temp
    ...
    characterData: {
            0: {
                ICON: "images/Elsword/icon_KE.png",
                CNAME: "Elsword",
                PNAME: "Knight Emperor",
                ROLE: "Synergy DPS",
                DTYPE: "Physical",
                Skills: [{
                    name: "Early",
                    skills: [
                    { id: "Els_TripleGeyser", isMod: false },
                    { id: "KE_VerticalSlash", isMod: false },
                    { id: "KE_ImperialCrusher", isMod: false },
                    { id: "Els_IronBody", isMod: false },
                    { id: "KE_GrandCross", isMod: false },
                    { id: "KE_GiganticSlash", isMod: false },
                    { id: "KE_ArmorBreak", isMod: true },
                    { id: "KE_Windmill", isMod: true },
                    { id: "KE_Sandstorm", isMod: true },
                    { id: "KE_ArmageddonBlade", isMod: true },
                    { id: "KE_DoubleSlash", isMod: true },
                    { id: "KE_SwordOfTheSunSolariusS1", isMod: false },
                    ]},
                    {
                    name: "Late",
                    skills: [
                    { id: "Els_TripleGeyser", isMod: false },
                    { id: "Els_UnlimitedBlade", isMod: true },
                    { id: "Els_FlameGeyser", isMod: true },
                    { id: "Els_IronBody", isMod: false },
                    { id: "KE_GrandCross", isMod: false },
                    { id: "KE_AbsoluteJudgement", isMod: false },
                    { id: "KE_ArmorBreak", isMod: true },
                    { id: "KE_ImperialCrusher", isMod: false },
                    { id: "KE_Sandstorm", isMod: true },
                    { id: "KE_ArmageddonBlade", isMod: true },
                    { id: "KE_DoubleSlash", isMod: true },
                    { id: "KE_SwordOfTheSunSolariusS4", isMod: false },
                    ]},
                    {
                    name: "Farm",
                    skills: [
            ...
            2: {
                ICON: "images/Elsword/icon_IM.png",
                CNAME: "Elsword",
                PNAME: "Immortal",
                ROLE: "DPS",
                DTYPE: "Physical",
            ...
            3: {
                ICON: "images/Elsword/icon_GS.png",
                CNAME: "Elsword",
                PNAME: "Genesis",
                ROLE: "DPS",
                DTYPE: "Magical",
                ...
                AddN: "-",
                dchp: "Near Selfish DPS Path that does great amount of damage",
                blchpheal: ["None"],
                blchpbuff: ["-"],
                blchpdebuff: ["-"],
                htuchp: "placeholder"
            ...
            4: {
                ICON: "images/Aisha/icon_AeS.png",
                CNAME: "Aisha",
                PNAME: "Aether Sage",
                ROLE: "DPS",
                DTYPE: "Magical",
            ...
            6: {
                ICON: "images/Aisha/icon_MtM.png",
                CNAME: "Aisha",
                PNAME: "Metamorphy",
                ROLE: "DPS",
                DTYPE: "Physical",
            ...
            7: {
                ...
                AddN: "-",
                dchp: "-",
                blchpheal: ["Heals by 10%"],
                blchpbuff: ["Increases Party Attack by 15%"],
                blchpdebuff: ["Reduces Enemy Defense by 10%"],
                htuchp: "-"
            },
            8: {
                ICON: "images/Rena/icon_AN.png",
                CNAME: "Rena",
                PNAME: "Anemos",
                ROLE: "DPS",
                DTYPE: "Physical",
            ...
            10: {
                ...
                dchp: "-",
                blchpheal: ["None"],
                blchpbuff: ["40% Damage Reduction"],
                blchpdebuff: ["Reduces Enemy Physical Defense by 30%","Increases Enemy Physical Damage Taken by 15%"],
                htuchp: "-"
            },
            11: {
                ICON: "images/Rena/icon_PR.png",
                CNAME: "Rena",
                PNAME: "Prophetess",
                ROLE: "Synergy DPS",
                DTYPE: "Magical",
                ...
                AddN: "-",
                dchp: "-",
                blchpheal: ["5% HP/MP Recovery per second"],
                blchpbuff: ["20% Damage Reduction", "20% Self Bravery Skill Damage Increase","20% Self Strength Skill Damage Increase", "10% All Damage Increase"],
                blchpdebuff: ["Reduces Enemy Magical Defense by 15%"],
                htuchp: "-"
            },
            12: {
                ICON: "images/Raven/icon_FB.png",
                CNAME: "Raven",
                PNAME: "Furious Blade",
                ROLE: "DPS",
                DTYPE: "Physical",
            ...
            14: {
                ICON: "images/Raven/icon_NI.png",
                CNAME: "Raven",
                PNAME: "Nova Imperator",
                ROLE: "DPS",
                DTYPE: "Magical",
                Skills: [{
                    name: "Default",
            ...
            19: {
                ICON: "images/Eve/icon_CA.png",
                CNAME: "Eve",
                PNAME: "Code: Antithese",
                ROLE: "DPS",
                DTYPE: "Physical",
                Skills: [{
                    name: "Default",
            ...
            20: {
                ICON: "images/Chung/icon_CC.png",
                CNAME: "Chung",
                PNAME: "Comet Crusader",
                ROLE: "Synergy DPS",
                DTYPE: "Physical",
                Skills: [{
                    name: "Default",
            ...
            22: {
                ICON: "images/Chung/icon_Cent.png",
                CNAME: "Chung",
                PNAME: "Centurion",
                ROLE: "DPS",
                DTYPE: "Magical",
            ...
            26: {
                ICON: "images/Ara/icon_Shakti.png",
                CNAME: "Ara",
                PNAME: "Shakti",
                ROLE: "DPS",
                DTYPE: "Physical",
            ...
            28: {
                ICON: "images/Elesis/icon_ES.png",
                CNAME: "Elesis",
                PNAME: "Empire Sword",
                ROLE: "Synergy DPS",
                DTYPE: "Physical",
            ...
            29: {
                ICON: "images/Elesis/icon_FL.png",
                CNAME: "Elesis",
                PNAME: "Flame Lord",
                ROLE: "DPS",
                DTYPE: "Magical",
            ...
            30: {
                ICON: "images/Elesis/icon_BQ.png",
                CNAME: "Elesis",
                PNAME: "Bloody Queen",
                ROLE: "DPS",
                DTYPE: "Physical",
            ...
            31: {
                ICON: "images/Elesis/icon_AD.png",
                CNAME: "Elesis",
                PNAME: "Adrestia",
                ROLE: "Synergy DPS",
                DTYPE: "Magical",
            ...
            36: {
                ICON: "images/LuCiel/icon_CaT.png",
                CNAME: "Lu/Ciel",
                PNAME: "Catastrophe",
                ROLE: "Synergy DPS",
                DTYPE: "Physical",
            ...
            39: {
                ICON: "images/LuCiel/icon_DeM.png",
                CNAME: "Lu/Ciel",
                PNAME: "Demersio",
                ROLE: "Support",
                DTYPE: "Magical",
            ...
            40: {
                ICON: "images/Rose/icon_TB.png",
                CNAME: "Rose",
                PNAME: "Tempest Burster",
                ROLE: "DPS",
                DTYPE: "Physical",
                Skills: [{
                    name: "Default",
            ...
            41: {
                ICON: "images/Rose/icon_BlM.png",
                CNAME: "Rose",
                PNAME: "Black Massacre",
                ROLE: "DPS",
                DTYPE: "Physical",
                Skills: [{
                    name: "Early",
                    skills: [
                        { id:"BlM_MultiHeadShot" , isMod: true },
                        { id:"BlM_BloodySpike" , isMod: true },
                        { id:"BlM_KillPoint" , isMod: false },
                        { id:"BlM_MovingShot" , isMod: false },
                        { id:"BlM_GunDance" , isMod: true },
                        { id:"BlM_BloodAndChain" , isMod: false },
                        { id:"BlM_BloodyChain" , isMod: false },
                        { id:"BlM_BloodBullet" , isMod: false },
                        { id:"BlM_RushingDance" , isMod: false },
                        { id:"BlM_Punishment" , isMod: false },
                        { id:"BlM_BloodyCarnival" , isMod: true },
                        { id:"BlM_PlainMadnessS1" , isMod: false },
                    ]},
                    {
                    name: "Late",
                    skills: [
                        ...
                        { id:"BlM_KillPoint" , isMod: false },
                        { id:"BlM_Punishment" , isMod: false },
                        { id:"Ros_M-3Flamethrower" , isMod: true },
                        { id:"BlM_DestroyersChain" , isMod: false },
                        { id:"BlM_BloodyChain" , isMod: false },
                        { id:"BlM_BloodBullet" , isMod: false },
                        { id:"Ros_Barbecue" , isMod: true },
                        { id:"BlM_GunDance" , isMod: true },
                        { id:"BlM_BloodyCarnival" , isMod: true },
                        { id:"BlM_PlainMadnessS4" , isMod: false },
                    ]},
                    {
                    name: "Farm",
                    skills: [
                ...
                AddN: "-",
                dchp: ['"Which would you prefer? A hole on your head? Or all diced up!"',"The restoration of the El exposes Rose to an augmented El energy which amplifies the power of the Dark El within her. The Dark El created by demons whose aim was to destroy Elrios is filled with hate and murderous intent. Rose, unstable with uncertainty and self-blame, becomes consumed by the demonic energy of the Dark El.",'"Die... for the princess."',"Now, her boundaries between good and evil have been blurred. The only thing that remains is her obsession towards the princess and the traces of blood-stained footprints from her enemies."],
                blchpheal: [""],
                blchpbuff: [""],
                blchpdebuff: [""],
                htuchp: "-"
            ...
            43: {
                ICON: "images/Rose/icon_PO.png",
                CNAME: "Rose",
                PNAME: "Prime Operator",
                ROLE: "Synergy DPS",
                DTYPE: "Magical",
                Skills: [{
                    name: "Default",
            ...
            48: {
                ICON: "images/Laby/icon_EtW.png",
                CNAME: "Laby",
                PNAME: "Eternity Winner",
                ROLE: "DPS",
                DTYPE: "Physical",
                Skills: [{
                    name: "Default",
            ...
            50: {
                ICON: "images/Laby/icon_NL.png",
                CNAME: "Laby",
                PNAME: "Nisha Labyrinth",
                ROLE: "DPS",
                DTYPE: "Physical",
                Skills: [{
                    name: "Default",
            ...
            52: {
                ...
                Skills: [{
                    name: "Early",
                    skills: [
                        { id: "Lib_ShadowFang", isMod: false },
                        { id: "Lib_ObsidianMoon", isMod: false },
                        { id: "Noa_DarkMoon", isMod: false },
                        { id: "Lib_Pursuit", isMod: false },
                        { id: "Lib_NewMoonsShadow", isMod: false },
                        { id: "Lib_DevouredMoon", isMod: false },
                        { id: "Lib_Boundary", isMod: true },
                        { id: "Noa_TheHourBetweenDogAndWolf", isMod: false },
                        { id: "Lib_DanceOfMidnight", isMod: false },
                        { id: "Lib_InstantOpening", isMod: false },
                        { id: "Lib_SilentAbyss", isMod: false },
                        { id: "Lib_MoonEclipseS1", isMod: false },
                    ]},
                    {
                    name: "Late",
                    skills: [
                        { id: "Noa_QuickStrike", isMod: true },
                        { id: "Lib_ObsidianMoon", isMod: false },
                        { id: "Noa_DarkMoon", isMod: true },
                        { id: "Lib_Pursuit", isMod: false },
                        { id: "Lib_NewMoonsShadow", isMod: false },
                        { id: "Lib_TheEnd", isMod: false },
                        { id: "Lib_Boundary", isMod: true },
                        { id: "Noa_TheHourBetweenDogAndWolf", isMod: false },
                        { id: "Lib_DanceOfMidnight", isMod: false },
                        { id: "Lib_InstantOpening", isMod: false },
                        { id: "Lib_SilentAbyss", isMod: false },
                        { id: "Lib_MoonEclipseS4", isMod: false },
                    ]},
                    {
                    name: "Farm",
                    skills: [
                        ...
                        { id: "Noa_TheHourBetweenDogAndWolf", isMod: false },
                        { id: "Lib_DanceOfMidnight", isMod: false },
                        { id: "Lib_NeedleIce", isMod: false },
                        { id: "Lib_SilentAbyss", isMod: false },
                        { id: "Lib_MoonEclipseS4", isMod: false },
                    ]}
                ],
                AddN: "-",
                dchp: ['"There is no duty or responsibility. This is my will."',"A journey for revenge. He pushed himself to come this far with the resolve to exact vengeance on the Henir zealot who destroyed the world and murdered his brother. He knew it was pointless to torment himself with figuring out why he was the only survivor. However, thanks to everything he's experienced so far, he realizes that he cannot go on without his own goal.","Noah knew from the beginning that his brother wouldn't want revenge, but without that goal, he would've been lost, without a reason to live. His kind-hearted brother became a safe haven for him even until the last moment, but now that he's remembered the sincerity his brother tried to teach him, and realizing this repetition isn't a curse but a chance, he couldn't stay a child any longer.","Although he lived through a time that wasn't his own because of a goal that wasn't his, the struggles he went through and the bonds he made are his own. He no longer wants to lose what's precious to him. To protect what he has right now, and to make sure no one suffers the same fate as him, the goal he must walk toward became clear.",'"I will make sure this tragedy will not be repeated — that is my choice and my will."',"Facing the truth, and freeing himself from the pressure of revenge, he becomes a master of the shadow who unveils darkness by his own will."],
                blchpheal: [""],
                blchpbuff: [""],
                blchpdebuff: [""],
                htuchp: "-"
            ...
            56: {
                ICON: "images/Lithia/icon_GB.png",
                CNAME: "Lithia",
                PNAME: "Gembliss",
                ROLE: "DPS",
                DTYPE: "Physical",
            ...
            57: {
                ICON: "images/Lithia/icon_AV.png",
                CNAME: "Lithia",
                PNAME: "Avarice",
                ROLE: "Support",
                DTYPE: "Physical",
            ...
            58: {
                ICON: "images/Lithia/icon_AC.png",
                CNAME: "Lithia",
                PNAME: "Achlys",
                ROLE: "Synergy DPS",
                DTYPE: "Magical",
            ...
            59: {
                ICON: "images/Lithia/icon_MC.png",
                CNAME: "Lithia",
                PNAME: "Mischief",
                ROLE: "DPS",
                DTYPE: "Magical",
